...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<org.example.HelloProto.HelloRequest,
      org.example.HelloProto.HelloResponse> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = org.example.HelloProto.HelloRequest.class,
      responseType = org.example.HelloProto.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<org.example.HelloProto.HelloRequest,
      org.example.HelloProto.HelloResponse> getSayHelloMethod() {
    io.grpc.MethodDescriptor<org.example.HelloProto.HelloRequest, org.example.HelloProto.HelloResponse> getSayHelloMethod;
    if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
          HelloServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<org.example.HelloProto.HelloRequest, org.example.HelloProto.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.HelloProto.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.HelloProto.HelloResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void sayHello(org.example.HelloProto.HelloRequest request,
        io.grpc.stub.StreamObserver<org.example.HelloProto.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceStub
    ...
    /**
     */
    public void sayHello(org.example.HelloProto.HelloRequest request,
        io.grpc.stub.StreamObserver<org.example.HelloProto.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceBlockingV2Stub
    ...
    /**
     */
    public org.example.HelloProto.HelloResponse sayHello(org.example.HelloProto.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.example.HelloProto.HelloResponse> sayHello(
        org.example.HelloProto.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((org.example.HelloProto.HelloRequest) request,
              (io.grpc.stub.StreamObserver<org.example.HelloProto.HelloResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              org.example.HelloProto.HelloRequest,
              org.example.HelloProto.HelloResponse>(
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return org.example.HelloProto.getDescriptor();
    }
